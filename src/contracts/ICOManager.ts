...
export const ICO_MANAGER_ADDRESS = process.env.ICO_MANAGER_ADDRESS!;

export const ICO_MANAGER_ABI = [
  {
    "inputs": [
      {
...
export const icoManagerContract = getContract({
  client: client,
  chain,
  address: ICO_MANAGER_ADDRESS,
  abi: ICO_MANAGER_ABI,
});

export const purchasedEvent = prepareEvent({
  signature:
